...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        if ($this->input->is_ajax_request() === FALSE && $this->config->item('rest_ajax_only'))
        {
            ...
            $this->response([
                $this->config->item('rest_code_field_name') => self::HTTP_NOT_ACCEPTABLE,
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        {
            $this->response([
                $this->config->item('rest_code_field_name') => self::HTTP_FORBIDDEN,
                $this->config->item('rest_status_field_name') => FALSE,
        ...
        if ($this->config->item('rest_enable_keys') && $use_key && empty($this->rest->key) === FALSE && $this->_check_access() === FALSE)
        {
            ...
            $this->response([
                $this->config->item('rest_code_field_name') => self::HTTP_UNAUTHORIZED,
                $this->config->item('rest_status_field_name') => FALSE,
        ...
        {
            $this->response([
                $this->config->item('rest_code_field_name') => self::HTTP_METHOD_NOT_ALLOWED,
                $this->config->item('rest_status_field_name') => FALSE,
        ...
        if ($this->config->item('rest_enable_keys') && empty($this->rest->key) === FALSE)
        {
            ...
            {
                $response = [$this->config->item('rest_code_field_name') => self::HTTP_UNAUTHORIZED, $this->config->item('rest_status_field_name') => FALSE, $this->config->item('rest_message_field_name') => $this->lang->line('text_rest_api_key_time_limit')];
            ...
            if($authorized === FALSE)
            {
                ...
                $response = [$this->config->item('rest_code_field_name') => self::HTTP_UNAUTHORIZED, $this->config->item('rest_status_field_name') => FALSE, $this->config->item('rest_message_field_name') => $this->lang->line('text_rest_api_key_permissions')];
                $this->response($response, self::HTTP_UNAUTHORIZED);
        ...
        {
            $response = [$this->config->item('rest_code_field_name') => self::HTTP_UNAUTHORIZED, $this->config->item('rest_status_field_name') => FALSE, $this->config->item('rest_message_field_name') => $this->lang->line('text_rest_ip_address_time_limit')];
            $this->response($response, self::HTTP_UNAUTHORIZED);
    ...
    public function response($data = NULL, $http_code = NULL, $continue = FALSE, $header_key = NULL)
    {
        ...
        if(!empty($header_key)) $this->output->set_header('NusaSecret: ' . $header_key);
